...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'f2_mode_manager_node = encoder_bridge.f2_mode_manager_node:main',
		'tb3_marker159_f2_pose_node = encoder_bridge.tb3_marker159_f2_pose_node:main',
		'f2_map_astar_planner_node = encoder_bridge.f2_map_astar_planner_node:main',
        ],
    },
)
