...
FOLLOW_PARAMS = {
    'target_marker_id': 159,
    'follow_distance': 0.16,
    'map_follow_center_distance': 0.16,
    'marker_far_distance': 0.15,
    'marker_pulse_distance': 0.09,
    'marker_hold_min_distance': 0.06,
    'marker_hold_max_distance': 0.09,
    'marker_too_close_distance': 0.04,
    'marker_emergency_distance': 0.03,
...
def generate_launch_description():
    ...
    follow_node = Node(
        package='encoder_bridge',
        executable='turtlebot_to_f1_follow_node',
